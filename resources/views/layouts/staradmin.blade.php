            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown d-none d-lg-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="themeDropdown" style="min-width: 280px;">
                            <div class="dropdown-header text-center border-bottom pb-2">
                                <p class="mb-0 fw-bold">Choose Your Theme</p>
                            </div>
                            
                            <!-- Star Admin 2 Theme -->
                            <a class="dropdown-item preview-item py-3 {{ (Auth::user()->theme ?? 'staradmin') == 'staradmin' ? 'bg-light' : '' }}" 
                               onclick="event.preventDefault(); document.getElementById('theme-staradmin-form').submit();">
                                <div class="d-flex align-items-center">
                                    <span class="rounded-circle border me-3" style="width:24px;height:24px;background:linear-gradient(135deg, #667eea 0%, #764ba2 100%)"></span>
                                    <div>
                                        <div class="fw-bold">Star Admin 2</div>
                                        <small class="text-muted">Modern Bootstrap Template</small>
                                    </div>
                                    @if((Auth::user()->theme ?? 'staradmin') == 'staradmin')
                            ...
                            <!-- Soft UI (Sales) Theme -->
                            <a class="dropdown-item preview-item py-3 {{ (Auth::user()->theme ?? 'staradmin') == 'softui_sales' ? 'bg-light' : '' }}" 
                               onclick="event.preventDefault(); document.getElementById('theme-softui-sales-form').submit();">
                                <div class="d-flex align-items-center">
                                    <span class="rounded-circle border me-3" style="width:24px;height:24px;background:linear-gradient(310deg, #7928CA 0%, #cb0c9f 100%)"></span>
                                    <div>
                                        <div class="fw-bold">Soft UI (Sales)</div>
                                        <small class="text-muted">Elegant design from Sales project</small>
                                    </div>
                                    @if((Auth::user()->theme ?? 'staradmin') == 'softui_sales')
                                        <i class="fas fa-check text-success ms-auto"></i>
                                    @endif
                                </div>
                            </a>
                            ...
                            <!-- Sneat (Sales) Theme -->
                            <a class="dropdown-item preview-item py-3 {{ (Auth::user()->theme ?? 'staradmin') == 'sneat_sales' ? 'bg-light' : '' }}" 
                               onclick="event.preventDefault(); document.getElementById('theme-sneat-sales-form').submit();">
                                <div class="d-flex align-items-center">
                                    <span class="rounded-circle border me-3" style="width:24px;height:24px;background:linear-gradient(135deg, #696cff 0%, #5f61e6 100%)"></span>
                                    <div>
                                        <div class="fw-bold">Sneat (Sales)</div>
                                        <small class="text-muted">Clean design from Sales project</small>
                                    </div>
                                    @if((Auth::user()->theme ?? 'staradmin') == 'sneat_sales')
                                        <i class="fas fa-check text-success ms-auto"></i>
                                    @endif
                                </div>
                            </a>

                            <form id="theme-staradmin-form" action="{{ route('theme.update') }}" method="POST" class="d-none"> @csrf <input type="hidden" name="theme" value="staradmin"> </form>
                            <form id="theme-softui-sales-form" action="{{ route('theme.update') }}" method="POST" class="d-none"> @csrf <input type="hidden" name="theme" value="softui_sales"> </form>
                            <form id="theme-sneat-sales-form" action="{{ route('theme.update') }}" method="POST" class="d-none"> @csrf <input type="hidden" name="theme" value="sneat_sales"> </form>
                        </div>
                    </li>
                    @endauth
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('customers.index') }}" title="Customers">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('job-cards.index') }}" title="Job Cards">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('production.create') }}" title="Issue Job Order">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('corrugation.index') }}" title="Corrugation Plant">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('production.index') }}" title="Production">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('masters.index') }}" title="Masters">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#admin-menu" aria-expanded="false" aria-controls="admin-menu" title="Admin">
                        ...
                        <div class="collapse" id="admin-menu">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="{{ route('users.index') }}" title="User Management">User Management</a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{ route('company.setup') }}" title="Company Setup">Company Setup</a></li>
                                @endif
                                @if(Auth::user()->isAdmin() || Auth::user()->canViewMenu('audit_logs'))
                                <li class="nav-item"> <a class="nav-link" href="{{ route('audits.index') }}" title="Audit Logs">Audit Logs</a></li>
                                @endif
                            </ul>
                        </div>
                    </li>
